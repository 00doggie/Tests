...
import com.doggie.testingmod.entity.goals.BegsGoal;
...
public class GermanShepardEntity  extends TamableAnimal implements NeutralMob, IAnimatable {
    public GermanShepardEntity name;
    private final AnimationFactory factory = new AnimationFactory(this);
    private static final EntityDataAccessor<Boolean> DATA_INTERESTED_ID = SynchedEntityData.defineId(GermanShepardEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> DATA_COLLAR_COLOR = SynchedEntityData.defineId(GermanShepardEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(GermanShepardEntity.class, EntityDataSerializers.INT);
    ...
    public GermanShepardEntity(EntityType<? extends GermanShepardEntity> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new GermanShepardEntity.WolfPanicGoal(1.5D));
        this.goalSelector.addGoal(2, new SitWhenOrderedToGoal(this));
        this.goalSelector.addGoal(3, new GermanShepardEntity.WolfAvoidEntityGoal<>(this, Llama.class, 24.0F, 1.5D, 1.5D));
    ...
    public GermanShepardEntity getBreedOffspring(ServerLevel p_20656, AgeableMob p_149089_) {
        GermanShepardEntity germanShepardEntity = ModEntityTypes.GERMAN_SHEPARD.get().create(p_20656);
        UUID uuid = this.getOwnerUUID();
        if (uuid != null) {
            germanShepardEntity.setOwnerUUID(uuid);
            germanShepardEntity.setTame(true);
        }

        return germanShepardEntity;
    }
    ...
    public boolean canMate(Animal p_30392_) {
        ...
        if (p_30392_ == this) {
            ...
            return false;
        } else if (!(p_30392_ instanceof GermanShepardEntity)) {
            return false;
        } else {
            GermanShepardEntity germanShepardEntity = (GermanShepardEntity) p_30392_;
            if (!germanShepardEntity.isTame()) {
                return false;
            } else if (germanShepardEntity.isInSittingPose()) {

                return false;

            } else {
                return this.isInLove() && germanShepardEntity.isInLove();
    ...
    public boolean wantsToAttack(LivingEntity p_30389_, LivingEntity p_30390_) {
        if (!(p_30389_ instanceof Creeper) && !(p_30389_ instanceof Ghast)) {
            if (p_30389_ instanceof GermanShepardEntity) {
                GermanShepardEntity germanShepardEntity = (GermanShepardEntity)p_30389_;
                return !germanShepardEntity.isTame() || germanShepardEntity.getOwner() != p_30390_;
    ...
    public static boolean checkWolfSpawnRules(EntityType<GermanShepardEntity> p_186244_, LevelAccessor p_186245_, MobSpawnType p_186246_, BlockPos p_186247_, Random p_186248_) {
    ...
    class WolfAvoidEntityGoal<T extends LivingEntity> extends AvoidEntityGoal<T> {
        ...
        public WolfAvoidEntityGoal(GermanShepardEntity p_30454_, Class<T> p_30455_, float p_30456_, double p_30457_, double p_30458_) {
            super(p_30454_, p_30455_, p_30456_, p_30457_, p_30458_);
            this.germanShepardEntity = p_30454_;
        }

        public boolean canUse() {
            if (super.canUse() && this.toAvoid instanceof Llama) {
                return !this.germanShepardEntity.isTame() && this.avoidLlama((Llama)this.toAvoid);
            } else {
                return false;
            }
        }
        ...
        private boolean avoidLlama(Llama p_30461_) {
            return p_30461_.getStrength() >= GermanShepardEntity.this.random.nextInt(5);
        }

        public void start() {
            GermanShepardEntity.this.setTarget((LivingEntity)null);
            super.start();
        }
    ...
    class WolfPanicGoal extends PanicGoal {
        public WolfPanicGoal(double p_203124_) {
            super(GermanShepardEntity.this, p_203124_);
        }
