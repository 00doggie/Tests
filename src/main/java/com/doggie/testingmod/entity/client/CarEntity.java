...
public class CarEntity extends AbstractMinecart implements IAnimatable {
    public CarEntity(EntityType<?> p_38470_, Level p_38471_) {
        super(p_38470_, p_38471_);
    }

    public CarEntity(Level p_38473_, double p_38474_, double p_38475_, double p_38476_) {
