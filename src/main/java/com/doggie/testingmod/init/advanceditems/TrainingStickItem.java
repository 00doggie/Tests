...
import com.doggie.testingmod.capabilities.TrainingStickCapability;
import com.doggie.testingmod.procedures.TrainingStickItemRightclicked;
...
public class TrainingStickItem extends Item {
    public TrainingStickItem(Properties tab) {
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
        ...
        if (entity instanceof ServerPlayer serverPlayer) {
            NetworkHooks.openGui(serverPlayer, new MenuProvider() {
                ...
                public Component getDisplayName() {
                    return new TextComponent("Training Stick Item");
                }
        ...
        TrainingStickItemRightclicked.execute(world, x, y, z, entity);
        return ar;
    }

    @Override
    public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
        return new TrainingStickCapability();
    }
