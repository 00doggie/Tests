...
public enum ArmorMaterials implements ArmorMaterial {
    ...
    RUBY("ruby", 20, new int[]{2, 5, 7, 3}, 12, SoundEvents.ARMOR_EQUIP_GOLD, 0.0F, 0.0F, () -> {
        return Ingredient.of(ItemInit.RUBY.get());
    }),

        FIRE_ARMOR("fire_armor", 20, new int[]{2, 5, 7, 3}, 12, SoundEvents.ARMOR_EQUIP_GOLD, 0.0F, 0.0F, () -> {
            return Ingredient.of(Items.NETHERITE_INGOT);
